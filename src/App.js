...
class App extends Component {
   ...
   */
  buildChangeLogoTransaction = (oldLogo, logoKey, newText, newTextColor, newFontSize, newBackgroundColor, newBorderWidth, newBorderColor, newBorderRadius, newPadding, newMargin) => {
